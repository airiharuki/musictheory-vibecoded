...
- ⬆️⬇️ Up/down indicators so you know which direction to pitch
...
- ⏱️ Supports 3/4, 4/4, 5/4, 6/8, and 7/8 time signatures
- 🏎️ BPM range from 40 to 240 (from "chill lo-fi" to "drum and bass nightmare")
...
4. Click play to hear the whole thing ▶️
5. Export as MIDI 💾
6. Open in your DAW
...
- [ ] 🌍 i18n support (music is universal, so should be this tool)
- [ ] 🧪 Unit tests (yeah yeah, we know)
- [ ] ♿ Accessibility improvements
- [ ] 🎤 Audio input for live key detection
